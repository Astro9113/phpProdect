...
$tpl = <<<EOF
<script type="text/javascript" src="http://{$rand}.{$domain}/abs/abs.php?type=1&num={$num}&uid={$uid}&width=0&height=0&cid=0&color={$color}&pid={$shopids}"></script>
EOF;
    ...
    $("#make").click(function(){
        ...
        $.ajax({
           cache: false,
  		   ...
  		   type: 'post',
  		   url: 'cps_1.php',
  		   data:{shopids:shopids,color:color,num:num,act:'make'},
