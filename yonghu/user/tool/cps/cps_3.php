...
$tpl = <<<EOF
<script type="text/javascript" src="http://{$rand}.{$domain}/abs/abs.php?type=2&num={$num}&uid={$uid}&width=0&height=0&cid=0&color={$color}&pid={$shopids}"></script>
EOF;
                ...
                <div class="vip-content-r-zijinsousuo" style="height: 1150px; min-width:1000px;">
                    ...
                    <div class="chongzhitaocan">
                        ...
                        <span>广告颜色</span>
                               ...
                               <option value="0" checked>黑色</option>
    ...
    $("#make").click(function(){
        ...
        $.ajax({
           cache: false,
  		   ...
  		   type: 'post',
  		   url: 'cps_3.php',
  		   data:{shopids:shopids,num:num,color:color,act:'make'},
