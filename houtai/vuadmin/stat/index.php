...
if($adminclass<>1){ //只有超级管理员允许查询微信主信息
    $username_s = '';
}
...
<?php
    ...
    $_time1 = (date('H')>=17)?date('Y-m-d').' 17:00:00':date('Y-m-d',time()-24*3600).' 17:00:00';
    $_time2 = (date('H')>=17)?date('Y-m-d',time()+24*3600).' 17:00:00':date('Y-m-d').' 17:00:00';
?>    
...
<div style='width:130%;'>
	...
	<a class='btn mtop12 mleft6' href="?time1=<?php echo $_time1;?>&time2=<?php echo $_time2;?>">今日出单</a>
</div>
...
<tr onmouseover="statbzxs('bz{$ww}')" onmouseout="statbzxs('bz{$ww}')">
	...
	<td><a target="_blank" href="statcon/?id={$info['id']}">详情</a>
	   <div class="statbzd">
