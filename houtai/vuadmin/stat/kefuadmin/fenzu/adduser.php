...
<div id="main" class="clearfix">  
 ...
 <h2>组长 <?php echo $zzname;?> 添加组员</h2>
		<div class="uc">
			<p>
				<a class="btn" href="javascript:history.go(-1);">返回</a> <a
					class="btn" href="userlist.php?id=<?php echo $id;?>">组员列表</a>
			</p>
...
<?php
    $sql = "select * from wx_kefu where level = 0 and pid = 0";
...
?>
                <tr>
					...
					<td><a href="#" class="adduser" data="<?php echo $info['id'];?>">加入该组</a></td>
				</tr>
<?php 
        }
    }
...
$(document).ready(function(){
	$('a.adduser').click(function(){
		...
		$.get('do_adduser.php?id='+uid+'&pid='+pid);			
	})
});
</script>