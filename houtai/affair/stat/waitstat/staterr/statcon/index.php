...
$id = intval($_GET['id']);
$sql = "select * from wx_guest where id = '{$id}' and gueststate = 13";
$info = $mysql->find($sql);
...
$alipay = htmlentities($user['alipay']);
$alipayname = htmlentities($user['alipayname']);
$topid = $user['topuser'];
...
<div id="wrap" class="clearfix">
    ...
    <div id="main" class="clearfix">
        ...
        <h2>
            <a class="btn" style="margin-top: 8px; float: right; margin-right: 12px;" href="/affair/stat/waitstat/staterr/?page=<?php echo $page;?>">返回列表</a>
    	</h2>
		<div class="uc">
			<div class="comform">
