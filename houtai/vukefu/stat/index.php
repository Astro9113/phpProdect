		...
		<div class="filter widthb110">
			...
			<div class="cxform2" style="width: 300px;">
				<form name="form1" method="get" action="guestnamesea/">
					姓名 <input name="guestname" type="text"
						style="width: 100px; height: 18px;">
						<input type="hidden" name="type" value="guestname">
					<button type="submit">查 询</button>
				</form>
			</div>
			...
			<div class="cxform2" style="width: 300px;">
				<form name="form1" method="get" action="guestnamesea/">
					电话 <input name="guestname" type="text"
						style="width: 100px; height: 18px;">
					<input type="hidden" name="type" value="guesttel">	
					<button type="submit">查 询</button>
				</form>
			</div>
			...
			<div class="cxform2" style="width: 300px;">
				<form name="form1" method="get" action="guestnamesea/">
					单号 <input name="guestname" type="text"
						style="width: 100px; height: 18px;">
					<input type="hidden" name="type" value="guestkuaidi">	
					<button type="submit">查 询</button>
				</form>
			</div>
