...
function sms_fahuo($guestid){
    ...
    $kfid = $info['guestkfid'];
    $kefu = get_kefu_info($kfid);
    $kftel = $kefu['tel']?$kefu['tel']:'15313659570';
    ...
    $msg = '您好'.$guestname.'，宝贝已发'.$wuliugs.'，快递单号：'.$guestkuaidi.'。客服电话'.$kftel.'，感谢订购祝您生活愉快！
';
    $ret = sms_xuanwu($guesttel, $msg);
    if($ret==0){
        return true;
    }else{
        return false;
...
function sms_xuanwu($mobile,$msg){
    $sms_user = 'bjysgw@bjysgw';
    $sms_pwd  = 'XeAeSJBx';
